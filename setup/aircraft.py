...
# ---- icons (side view, nose right). '#'/'o'/'@' = static lit, '*' = ANIMATED
# (rotor disc / propeller — the caller spins a bright spot along it). '.'/' '=empty.
_ART = {
    "heli": """
....*****************.....
..........###.............
...
def icon_for(code):
    """(static_px, anim_px, w, h, category) for an aircraft type code."""
    cat = category(code)
    static, anim, w, h = _ICONS[cat]
    return static, anim, w, h, cat
